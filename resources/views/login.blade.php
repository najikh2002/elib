...
<div class="max-w-2xl mx-auto flex flex-col justify-center items-center h-[630px]">
	<div
		class="bg-white shadow-md border border-gray-200 rounded-lg w-[90%] md:w-[60%] p-4 sm:p-6 lg:p-8">
		<form class="space-y-6" action="login" method="POST">
            @csrf

			<h3 class="text-xl text-center font-medium text-gray-900">LOGIN</h3>
			<div>
